...
class FoodOrderGUI(QWidget):
    ...
    def pizzaTab(self):
        ...
        pizza_desc = QLabel()
        pizza_desc.setObjectName("Image Info")
        pizza_desc.setText("Build a custom pizza for you. start with your\
                           favourite crust and add any toppings, plus the perfect amount\
                           of cheese and sauce.")
        ...
        toppings_list = ["Pepperoni", "Sausage", "Bacon", "Canadian Bacon",
                         "Beef", "Pineapple", "Mushroom", "Onion", "Olive",
                         "Green Pepper", "Tomato", "Spinach", "Cheese"]
    ...
    def wingsTab(self):
        ...
        description_box = QWidget()
        description_box.setObjectName("ImageBorder")
        wings_image_path = "images/wings.jpg"
        ...
        wings_gbox.setTitle("CHOOSE YOUR FLAVOUR")
        ...
        for fl in wings_list:
            flavour_rb = QRadioButton(fl)
            gb_v_box.addWidget(flavour_rb)
            self.wings_group.addButton(flavour_rb)
