...
class CreateEmployeeData:
    ...
    query.prepare("""INSERT INTO accounts (
                    empolyee_id, first_name, last_name,
    ...
    employees = {"USA": 1, "India": 2, "China": 3, "France": 4, "Germany": 5}
    ...
    for f_name in first_names:
        ...
        country_id = random.choice(departments)
        employeed_id = employee_ids.pop()
        query.addBindValue(employeed_id)
