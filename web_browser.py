...
class WebBrowser(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.setWindowIcon(QIcon(os.path.join("images", "redbayporticon.ico")))
    ...
    def createToolbar(self):
        ...
        back_page_button = QAction(QIcon(os.path.join("images", "back.png")), "Back", self)
        back_page_button.triggered.connect(self.backPageButton)

        forward_page_button = QAction(QIcon(os.path.join("images", "forward.png")), "Forward", self)
        ...
        self.address_line.addAction(QIcon("images/search.png"), QLineEdit.LeadingPosition)
