...
class PhotoEditor(QMainWindow, QWidget):
    def __init__(self):
        super().__init__()
        self.initializeUI()
    ...
    def initializeUI(self):
        ...
        self.setWindowIcon(QIcon("images/redbayporticon.ico"))
    ...
    def createMenu(self):
        ...
        self.rotate90_act = QAction(u"Rotate 90\N{DEGREE SIGN}", self)
        self.rotate90_act.setStatusTip(u"Rotate Image 90\N{DEGREE SIGN} clockwise")
        self.rotate90_act.triggered.connect(self.rotateImage90)
        
        self.rotate180_act = QAction(u"Rotate 180\N{DEGREE SIGN}", self)
        self.rotate180_act.setStatusTip(u"Rotate image 180\N{DEGREE SIGN} clockwise")
    ...
    def createToolsDockWidget(self):
        ...
        self.rotate90 = QPushButton(u"Rotate 90\N{DEGREE SIGN}")
        self.rotate90.setMinimumSize(QSize(130, 40))
        self.rotate90.setStatusTip(u"Rotate image 90\N{DEGREE SIGN} clockwise")
        self.rotate90.clicked.connect(self.rotateImage90)
        
        self.rotate180 = QPushButton(u"Rotate 180\N{DEGREE SIGN}")
        self.rotate180.setMinimumSize(QSize(130, 40))
        self.rotate180.setStatusTip(u"Rotate image 180\N{DEGREE SIGN} clockwise")
    ...
    def openImage(self):
        """
        Open an image file and display its contents in label widget. Display error message if image can't be opened.
        """
    ...
    def rotateImage90(self):
        u"""
        Rotate image 90\N{DEGREE SIGN} clockwise
        """
    ...
    def rotateImage180(self):
        u"""
        Rotate image 180\N{DEGREE SIGN} clockwise
        """
        if self.image.isNull() == False:
